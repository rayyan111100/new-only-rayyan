...
export default function NistTab() {
  ...
  const loadMoreLogs = useCallback(async () => {
    ...
    try {
      ...
      const res = await api('search', { index: 'unishield360-alerts-*', start_date: sd, end_date: ed, q: '_exists_:rule.nist_800_53', limit: 10000, offset, sort: '@timestamp', order: 'desc' })
