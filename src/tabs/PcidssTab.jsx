    ...
    <motion.div ref={containerRef} data-export-container initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.15 }} className="p-3">
      ...
      <div className="grid grid-cols-6 gap-2.5 mb-3">
        {[
          ...
          { key: 'm-controls', label: 'Controls Triggered', val: controlsViolated, sub: 'Unique PCI-DSS requirements', icon: 'list-check', iconBg: '#3fb95018', iconColor: '#3fb950' },
          { key: 'm-top-ctrl', label: 'Top Triggered Control', val: topControlVal, sub: topControlSub, icon: 'award', iconBg: '#e8681a18', iconColor: ACCENT, valColor: ACCENT, valSize: 'text-base' },
        ].map(card => (
