...
export default function TscTab() {
  ...
  const fetchData = useCallback(async () => {
    try {
      const tp = timeParams()
      const d = await api('compliance', { index: 'unishield360-alerts-4.x-*', start_date: tp.start_date, end_date: tp.end_date, framework: 'TSC' })
      setData({
        count24: d.count24 || 0,
        count7d: d.count7d || 0,
        severity: d.severity || {},
          ...
          <div className="bg-white dark:bg-[#161b22] border border-[#d0d7de] dark:border-[#30363d] rounded-xl p-5 w-[500px] max-h-[72vh] overflow-y-auto shadow-lg" onClick={e => e.stopPropagation()}>
            ...
            <div className="grid grid-cols-2 gap-2.5 mb-3">
              {[
                ...
                { label: 'SOC 2 Control', val: l.ctrl, cls: 'text-[#e8681a] font-semibold' },
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.15 }} className="p-3">
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <div className="flex items-center gap-2 mt-1.5">
          <DateRangePicker />
          <button onClick={() => { setLoading(true); fetchData() }} className="p-1.5 rounded border border-transparent hover:bg-[#21262d] text-[#8b949e] hover:text-[#e8681a] transition-colors">
